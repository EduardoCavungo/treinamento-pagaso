...
class BancosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banco" do
    assert_difference('Banco.count') do
      post bancos_url, params: { banco: { email: @banco.email, morada: @banco.morada, nome: @banco.nome, sigla: @banco.sigla, telefone: @banco.telefone, web_site: @banco.web_site } }
    end
  ...
  test "should update banco" do
    patch banco_url(@banco), params: { banco: { email: @banco.email, morada: @banco.morada, nome: @banco.nome, sigla: @banco.sigla, telefone: @banco.telefone, web_site: @banco.web_site } }
